              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-4xl font-bold">
                    {userContext.user.membresia?.fecha_fin ? calculateRemainingDays(new Date(userContext.user.membresia.fecha_fin)) : "N/A"}
                  </p>
                  <p className="text-sm opacity-80">días restantes</p>
                </div>
                <div className="w-1/2">
                  <div className="h-2 rounded-full overflow-hidden" style={{ backgroundColor: "#ffffff33" }}>
                    <div
                      className="h-full rounded-full"
                      style={{
                        width: `${(calculateRemainingDays(membresia.fecha_fin) / 365) * 100}%`,
                        backgroundColor:
                          calculateRemainingDays(membresia.fecha_fin) > 20
                            ? "green"
                            : calculateRemainingDays(membresia.fecha_fin) > 10
                            ? "orange"
                            : "red",
                      }}
                    ></div>
                  ...
                  <p className="text-sm mt-2 text-right opacity-80">
                    Vence: {new Date(membresia.fecha_fin).toLocaleDateString()}
                  </p>
                </div>
              </div>
            </div>
